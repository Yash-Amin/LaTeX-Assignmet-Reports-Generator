...
class QuestionImageSection extends Component {
    state = {
        type: 'image',
        id: this.props.id,
        captionNum: '',
    ...
    uploadImage = file => {
        ...
        axios
            ...
            .then(res => {
                console.log(res);
                // alert('Uploaded, que' + JSON.stringify(res.data.filename) + '::');
                let newState = {
                    ...this.state,
                    uploading: false,
                    uploaded: true,
    ...
    handleInputChange = event => {
        ...
        if (event.target.name == 'queFileUpload') {
                        ...
                        <Grid container alignContent="center">
                            ...
                            <Grid item style={{ padding: '8px' }}>
                                <input
                                    ...
                                    onChange={this.handleInputChange}
                                    id={
                                        'file-upload-button-que' + this.state.id
                                    }
                                    type="file"
                                />
                                <label
...
//     return {
//         items: state. QuestionImageSections
//     };
// };
...
//     };
// };
// export default connect(mapStateToProps)( QuestionImageSection);
export default connect()(QuestionImageSection);
